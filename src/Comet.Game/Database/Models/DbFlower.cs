...
namespace Comet.Game.Database.Models
{
    ...
    public class DbFlower
    {
        ...
        [Column("player_id")] public uint UserIdentity { get; set; }
        ...
        public static async Task<DbFlower> GetAsync(uint idUser)
        {
            await using var ctx = new ServerDbContext();
            return await ctx.Flowers.FirstOrDefaultAsync(x => x.UserIdentity == idUser);
        }
    }
}